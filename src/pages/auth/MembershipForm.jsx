      ...
      if (response.statuscode === 200) {
        ...
        Modal.success({
          ...
          content: (
            <div>
              <p>
                Please save your password and email. This message will disappear
                once you close it.
              </p>
              <p>
    ...
    <div className="regContainer">
      <div className="membershipContainer">
        ...
        >
              ...
              >
                ...
                >
                  {gender.map((genderOption) => (
                    <Radio key={genderOption.value} value={genderOption.value}>
                      {genderOption.label}
                    </Radio>
                  ))}
                </Radio.Group>
          ...
          <div className="form-group">
            <label className="form-label">
              Which year you left CCI? <br /> आपन बाल गह िकस वष छोड़ा?
            </label>
            <div className="form-input">
              <Form.Item
                name="year_left_cci"
          ...
          <div className="form-group">
            <label className="form-label">
              ...
              राज्य केयर लीवस नेटवर्क सदस्य हैं?
            </label>
            <div className="form-input">
              <Form.Item
              ...
              >
                ...
                >
                  {member.map((memberOption) => (
                    <Radio key={memberOption.value} value={memberOption.value}>
                      {memberOption.label}
                    </Radio>
                  ))}
                </Radio.Group>
          ...
          <div className="form-group">
            <label className="form-label">
              Tell us about your three strengths (in three words only): <br />{" "}
              अपनी तीन ताकतों के बारे में बताएं (केवल तीन शब्दों में)
            </label>
            <div className="form-input">
              <Form.Item
                name="strengths"
