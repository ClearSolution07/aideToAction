  ...
  return (
    ...
    >
      <div style={{ textAlign: "center", marginBottom: "32px" }}>
        ...
        />
        <Title level={2}>Saarthi : Care Leavers Network: Membership Form</Title>
        <Paragraph>
      ...
      <div style={{ textAlign: "justify", marginBottom: "4rem" }}>
        ...
        <Paragraph>
          You'll be part of a constantly growing and thriving community of care
          experienced youths across India. This community is of, for and by care
          experienced youths/care leavers.
        </Paragraph>
        <Paragraph>
          ...
          even the membership form altogether. However, we encourage you to fill
          out the form and be a part of the Saarthi-AICL network.
        </Paragraph>
        <Paragraph>
        ...
        <Paragraph>
          ...
          people who have lived at least three years (or less depending on their
          personal circumstances) in any Child Care Institution. Care Leavers'
          Network is a formal or informal group of care leavers at
          ...
          state networks of care leavers in India. Its aim is to create a common
          platform for care leavers to connect, utilize opportunities of growth,
          gain referrals for various platforms of support, and bring forth your
          issues at pan India level. This network has been formed under a
          project being implemented in partnership of Aide et Action and UNICEF.
        </Paragraph>
        <Paragraph>
          <Paragraph>
            {" "}
          ...
          statutory repercussions arising out of any activity or statement done
          or undertaken by members at their individual or group level using the
          network's name.
        </Paragraph>
        <Paragraph>
        ...
        <Paragraph>
          ...
          अनुभव वाले युवाओं के एक लगातार बढ़ते और फलते-फूलते समुदाय का हिस्सा बन
          जाएंगे। यह समुदाय देखभाल अनुभव वाले युवाओं/देखभाल छोड़ने वालों का है,
          उनके लिए और उनके द्वारा।
        </Paragraph>
        <Paragraph>
          कृपया इस ऑनलाइन फॉर्म को भरें और सदस्य के रूप में हमसे जुड़ें। यदि आप
          कोई जानकारी प्रकट नहीं करना चाहते हैं, तो आप प्रश्न को छोड़ सकते हैं
          या यहां तक कि सदस्यता फॉर्म को भी छोड़ सकते हैं। हालांकि, हम आपको
          फॉर्म भरने और सारथी-एआईसीएल नेटवर्क का हिस्सा बनने के लिए प्रोत्साहित
          करते हैं। यदि आपके पास सारथी-एआईसीएल (Saarthi - AICL) सदस्यता या डेटा
          संग्रह प्रक्रिया के बारे में कोई प्रश्न या चिंता है, तो कृपया हमसे
          8700190013 पर संपर्क करने में संकोच न करें।
        </Paragraph>
        <Paragraph>
        ...
        <Paragraph>
          ...
          धर्म/वर्ग/लिंग/यौन अभिविन्यास/शारीरिक क्षमता/संस्थान का प्रकार कुछ भी
          हो।
        </Paragraph>
        <Paragraph>
          सारथी-एआईसीएल (Saarthi -AICL) भारत में राज्य नेटवर्कों का एक राष्ट्रीय
          संघ है। इसका उद्देश्य देखभाल छोड़ने वालों को जोड़ने, विकास के अवसरों
          का उपयोग करने, विभिन्न समर्थन प्लेटफार्मों के लिए संदर्भ प्राप्त करने
          और आपके मुद्दों को पैन इंडिया स्तर पर लाने के लिए एक सामान्य मंच बनाना
          है।
        </Paragraph>
        <Paragraph>
          यह नेटवर्क एड एट एक्शन (Aide Et Action)और यूनिसेफ (UNICEF) की साझेदारी
          में लागू की जा रही एक परियोजना के तहत बनाया गया है।
        </Paragraph>
        <Paragraph>
        ...
        <Paragraph>
          Saarthi -AICL एक पंजीकृत या लाभकारी नेटवर्क नहीं है। एड एट एक्शन (Aide
          Et Action) या यूनिसेफ (UNICEF) पर कोई वित्तीय, कानूनी या वैधानिक
          दायित्व नहीं है और न ही इसके विपरीत। एड एट एक्शन (Aide Et Action) और
          यूनिसेफ (UNICEF) किसी भी वित्तीय, कानूनी या वैधानिक परिणामों के लिए
          जिम्मेदार नहीं होंगे जो सदस्यों द्वारा व्यक्तिगत या समूह स्तर पर
          नेटवर्क के नाम का उपयोग करके किए गए किसी भी गतिविधि या बयान से उत्पन्न
          होते हैं।
        </Paragraph>
        <Paragraph>
          हमारा उद्देश्य केवल सदस्यता के माध्यम से देखभाल छोड़ने वाले समुदाय को
          मजबूत और विस्तारित करने के लिए एक मंच प्रदान करना है
        </Paragraph>
        <Paragraph>
        ...
        <Paragraph>
          <strong>
            {" "}
            Please follow NCLN on social medial platforms to stay updated.😍😍😍
          </strong>
        </Paragraph>
        <Paragraph>
      ...
      >
        ...
        <Row gutter={16}>
          <Col span={8}>
            <Form.Item
              label={
                <>
                  Are you a member of state care leavers network? <br /> क्या आप
                  राज्य केयर लीवस नेटवर्क सद ह?
                </>
              }
            />
          </Col>
            ...
            <Form.Item
              label={
                <>
                  ...
                  <br /> अपनी तीन ताकतों के बारे में बताएं (केवल तीन शब्दों में)
                </>
              }
            />
          </Col>
        ...
        <div style={{ marginBottom: 24 }}>
          ...
          <Space direction="vertical">
            <Space>
              <InstagramOutlined />
              <Link href="https://www.instagram.com/ncln_india" target="_blank">
                @ncln_india
              </Link>
            </Space>
            <Space>
